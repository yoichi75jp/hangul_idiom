...
{
    static private int DB_VERSION = 1;  //2018/09/09 ver.1
    final static private String DB_NAME = "hangul_idiom";
    final static private String DB_NAME_ASSET = "hangul_idiom.db";
    final static private String DB_NAME_ZIP = "hangul_idiom.zip";
